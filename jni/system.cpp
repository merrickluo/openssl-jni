...
jstring Java_me_smartproxy_crypto_CryptoUtils_getabi(JNIEnv *env, jobject thiz) {
...
void Java_me_smartproxy_crypto_CryptoUtils_exec(JNIEnv *env, jobject thiz, jstring cmd) {
